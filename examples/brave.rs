/// Run with: cargo run --example brave -- "your query"
use std::sync::Arc;

use metadata_search_engine_rs::engines::{BraveEngine, SearchEngine, build_http_client};
